                ...
                <div class="col-sm-9">
                  ...
                  ?>
                    <div class="ckbox ckbox-primary">
                      <input type="checkbox" class="parentmenu_<?php echo $queryMenuActive->MenuId;?>" id="menu_<?php echo $queryMenuActive->MenuId;?>" value="<?php echo $queryMenuActive->MenuId;?>" name="menu[]" />
                      ...
                      ?>
                              <div class="ckbox ckbox-primary">
                                &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" class="childmenu_<?php echo $queryMenuActiveChild->MenuParentId;?>" id="menu_<?php echo $queryMenuActiveChild->MenuId;?>" value="<?php echo $queryMenuActiveChild->MenuId;?>" name="menu[]" />
