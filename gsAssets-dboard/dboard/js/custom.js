/* ======================================== 
    ...
    Description   : CUSTOM JS FUNCTION.
=========================================== */
...
jQuery(window).load(function() {
   ...
   jQuery('#preloader').delay(50).fadeOut(function(){
      jQuery('#contentpanel').delay(50).css({'overflow':'visible'});
   });
});
...
jQuery(document).ready(function() {
  ...
  function showTooltip(x, y, contents) {
   ...
   jQuery("#dashboardChartBar").bind("plothover", function (event, pos, item) {
   ...
   jQuery("#dashboardChartBar").bind("plotclick", function (event, pos, item) {
    if (item) {
